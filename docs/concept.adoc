...
*Sakuli* depends on *Java* and should run on most OS:
* *Windows*
* *MacOS*
* *Linux*: Ubuntu Linux (14.04 + 16.04), CentOS 7 and OpenSUSE 13.2 are tested.
* *Docker Containers*: see <<containerized_execution>>
