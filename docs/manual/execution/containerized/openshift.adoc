...
Then you can use the provided templates:

// TODO TS: hier fehlt doch was, oder? Im nächsten Abschnit gehts mit dem gleichen command wieder los.
...
//TODO TS: image statt Dockerfile = korrekt?
Alternatively you can build a custom image in a specific branch:
