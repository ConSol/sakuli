...
include::manual/execution/native/testcase-filtering.adoc[]
...
//Sakuli UI
include::manual/ui/sakuli-ui.adoc[]
...
include::manual/integration/forwarder-concept.adoc[]
include::manual/integration/sql-database.adoc[]
include::manual/integration/json-forwarder.adoc[]
