...
package de.consol.sakuli.actions.logging;

import de.consol.sakuli.datamodel.actions.LogLevel;

/**
 * The logging will take place in the {@link de.consol.sakuli.aop.RhinoAspect}.
 * This are only EntryPoints for {@link de.consol.sakuli.aop.RhinoAspect#doLoggingLog(org.aspectj.lang.JoinPoint, LogToResult)}.
 *
 * @author tschneck
 *         Date: 24.06.13
 */
