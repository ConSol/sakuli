...
public class SakuliProperties extends AbstractProperties {
    ...
    public static final String SAKULI_MAIN_FOLDER = "sakuli.main.folder";
    ...
    public static final String TESSDATA_LIB_FOLDER_APPEDER = LIBS_FOLDER_APPEDER + File.separator + "tessdata";
    private static final boolean SUPPRESS_RESUMED_EXCEPTIONS_DEFAULT = false;
    @Value("${" + SAKULI_MAIN_FOLDER + "}")
    private String sakuliMainFolderPropertyValue;
    private Path sakuliMainFolder;
    ...
    public void initFolders() throws FileNotFoundException {
        sakuliMainFolder = Paths.get(sakuliMainFolderPropertyValue).normalize();
        checkFolders(sakuliMainFolder);
        configFolder = Paths.get(sakuliMainFolder + CONFIG_FOLDER_APPEDER);
        checkFolders(configFolder);
        jsLibFolder = Paths.get(sakuliMainFolder + JS_LIB_FOLDER_APPEDER);
        checkFolders(jsLibFolder);
        tessDataLibFolder = Paths.get(sakuliMainFolder + TESSDATA_LIB_FOLDER_APPEDER);
    ...
    public String getSakuliMainFolderPropertyValue() {
        return sakuliMainFolderPropertyValue;
    }

    public void setSakuliMainFolderPropertyValue(String sakuliMainFolderPropertyValue) {
        this.sakuliMainFolderPropertyValue = sakuliMainFolderPropertyValue;
    }

    public Path getSakuliMainFolder() {
        return sakuliMainFolder;
    }

    public void setSakuliMainFolder(Path sakuliMainFolder) {
        this.sakuliMainFolder = sakuliMainFolder;
    }
