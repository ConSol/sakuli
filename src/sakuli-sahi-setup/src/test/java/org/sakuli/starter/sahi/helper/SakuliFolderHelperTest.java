...
import static org.sakuli.AbstractBaseTest.TEST_FOLDER_PATH;
import static org.testng.Assert.*;

public class SakuliFolderHelperTest {
    ...
    public void testCheckSahiProxyHomeAndSetContextVariables() throws Exception {
        ...
        assertEquals(SahiStarterPropertyPlaceholderConfigurer.SAHI_HOME_VALUE, absoluteSahiPath);
