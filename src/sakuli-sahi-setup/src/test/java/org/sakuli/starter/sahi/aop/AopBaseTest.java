...
public abstract class AopBaseTest extends BaseTest {
    ...
    protected String getTestContextPath() {
        return "org/sakuli/starter/sahi/aop/aopTest-beanRefFactory.xml";
    }
    ...
    protected void initMocks() {
        ...
        BeanLoader.loadBean(SahiActionLoader.class).setRhinoScriptRunner(new RhinoScriptRunner(sahiScriptMock));
    }
}
