...
/**
 * Wrapper for the Java based {@link de.consol.sakuli.actions.screenbased.Region} functions.
 *
 * @author Tobias Schneck
 */
public class Region extends de.consol.sakuli.actions.screenbased.Region {
