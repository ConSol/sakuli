...
:sakuli-latest-version: v1.3.0-SNAPSHOT
...
*Attention: Sakuli 1 will go into maintenance mode mid of 2019. There is an ongoing re-implementation which is also on https://github.com/sakuli/sakuli[GitHub]*
